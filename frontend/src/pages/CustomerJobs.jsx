...
import { ClipboardList, RefreshCw, Map, CheckCircle, Star, XCircle, Phone } from 'lucide-react';
...
const CustomerJobs = () => {
  ...
  return (
    <div className="container">
      ...
      {jobs.length === 0 ? <div className="empty-state"><div className="empty-icon" style={{display: 'flex', justifyContent: 'center', color: 'var(--text-muted)', marginBottom: '1rem'}}><ClipboardList size={48} /></div><p>No jobs yet. Go find a service provider!</p></div> : (
        <>
          {activeJobs.length > 0 && (
            <>
